...
def layer4_attack(target_ip, duration):
    ...
    while time.time() - start_time < duration:
        ...
        print(Fore.YELLOW + f"[L4] \033[100m {Fore.WHITE}ADMIN-HACK\033[0m {Fore.BLUE} SEN-PACKET {Fore.GREEN} {psize} {Fore.RED} BYTES TO {target_ip}:{port} {Fore.WHITE}Running ::")
        print(Fore.RED + f"[L4] {Fore.YELLOW}ADMIN-HACK {Fore.CYAN} SEN-PACKET {Fore.YELLOW} {psize} {Fore.WHITE} BYTES TO \033[104m{target_ip}:{port}\033[0m {Fore.GREEN}Running :")
        time.sleep(0.2)
